...
- **Create new The assistant skills** with proper structure and metadata
...
Also use these instructions when:
- **User says he wants to create/share his skill** 

these instructions is ideal for:
...
```
When you ask The assistant to create a skill called "pdf-analyzer":
...
these instructions leverages Rube for:
